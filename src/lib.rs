...
#[derive(Debug)]
pub struct CosmosSDKProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CosmosSDKProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CosmosSDK processing");
    
    let mut processor = CosmosSDKProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CosmosSDKProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CosmosSDKProcessor::new(false);
